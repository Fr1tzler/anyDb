...
import { validatePathMatch, getBaseUrl, getPathParams } from './server'
...
describe('Server utils', () => {
  ...
  describe('getPathParams', () => {
    it('should return an object with path parameters when the request path matches the controller path', () => {
      const requestPath = '/users/123'
      const controllerPath = '/users/:id'
